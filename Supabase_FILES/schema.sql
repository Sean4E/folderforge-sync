...
/*
-- Insert sample templates (replace USER_ID with actual user id)
INSERT INTO public.templates (id, owner_id, name, description, icon_type, color) VALUES
    ('11111111-1111-1111-1111-111111111111', 'USER_ID', 'Web Project', 'Standard web project structure', 'code', 'blue'),
    ('22222222-2222-2222-2222-222222222222', 'USER_ID', 'Video Production', 'Video editing project layout', 'media', 'pink'),
    ('33333333-3333-3333-3333-333333333333', 'USER_ID', 'Blender Assets', 'Blender project organization', 'assets', 'orange');

-- Insert sample folders for Web Project
INSERT INTO public.folders (template_id, parent_id, name, folder_type, sort_order) VALUES
    -- Root folders
    ('11111111-1111-1111-1111-111111111111', NULL, 'src', 'code', 1),
    ('11111111-1111-1111-1111-111111111111', NULL, 'assets', 'assets', 2),
    ('11111111-1111-1111-1111-111111111111', NULL, 'docs', 'docs', 3);
*/
