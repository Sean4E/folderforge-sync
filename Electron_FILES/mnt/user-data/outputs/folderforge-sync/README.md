...
See [electron/README.md](electron/README.md) for detailed setup instructions.
...
| Notifications | Get notified when folders are created |
...
- [x] Electron desktop agent
- [x] Add device modal with token generation
