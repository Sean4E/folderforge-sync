  ...
  const renderDevices = () => (
    <div className="space-y-6">
      ...
      <GlassCard className="p-6" hover={false}>
        <h3 className="text-white font-medium mb-4">Download Desktop Agent</h3>
        <div className="flex flex-col items-center justify-center py-8 border-2 border-dashed border-white/10 rounded-xl">
          ...
          <p className="text-zinc-400 text-sm text-center max-w-sm mb-4">
            Install the desktop agent on your computer to enable real-time sync and folder creation.
          </p>
